                ...
                <div class="col ">
                    <div class="card m-3">
                        <ul class="list-group list-group-flush">
                            ...
                            <li class="list-group-item">ID do documento: ${t.documentId}</li>
                            <li class="list-group-item">Hash do documento: ${t.documentHash}</li>
                            <li class="list-group-item">Tipo de transação: ${t.type}</li>
